...
export const ReferralRewardsPanel = ({ invitedCount = 0 }: { invitedCount?: number }) => {
  ...
  return (
    <section className="rounded-3xl border border-[#1F2937] bg-[#111827] p-5 shadow-elegant">
      ...
      <div className="mb-4 flex items-center gap-2 rounded-2xl border border-[#1F2937] bg-[#070A13] p-2">
        <input
          readOnly
          value={link}
          dir="ltr"
      ...
      <div className="mb-3 flex items-center justify-between rounded-2xl border border-[#1F2937] bg-[#070A13] p-3">
