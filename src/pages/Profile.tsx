...
const MissionsBlock = () => {
  ...
  return (
    <section className="rounded-3xl border border-border bg-surface-2 p-5 shadow-soft">
              ...
              <button
                ...
                className={cn(
                  "flex w-full items-center gap-3 rounded-xl border px-3 py-2 text-start transition-smooth",
                    ...
                    : "border-border bg-background text-white/85 hover:border-gold/40"
                )}
              >
                <span
                  className={cn(
...
const Profile = () => {
  ...
  return (
    <AppShell>
      {/* Brand header */}
      <header className="sticky top-0 z-30 border-b border-border bg-background/90 px-5 py-3 backdrop-blur-lg">
        <div className="flex items-center justify-between gap-3">
          ...
          <Link
            ...
            className="flex h-11 w-11 items-center justify-center rounded-full border border-border bg-surface-2 text-white/85 transition-smooth hover:text-gold"
          >
      ...
      <div className="space-y-4 px-5 pt-4">
        ...
        <section className="grid grid-cols-4 gap-2 rounded-2xl border border-border bg-surface-2 p-3">
        ...
        <section className="rounded-3xl border border-border bg-surface-2 p-5">
          ...
          <button className="flex w-full items-center gap-3 rounded-2xl border border-border bg-background p-4 text-start transition-smooth hover:border-gold/40">
        ...
        {/* Pro upsell */}
        {!USER.pro && (
          <section className="relative overflow-hidden rounded-3xl border border-gold/30 bg-gradient-to-br from-surface-2 via-background to-surface-2 p-6 text-white shadow-elegant">
          ...
          <div className="-mx-5 overflow-x-auto px-5">
            <div className="flex gap-2.5 pb-1">
              {RECEIVED_GIFTS.map((g) => (
                <div
                  key={g.id}
                  className="flex shrink-0 flex-col items-center gap-1 rounded-2xl border border-border bg-gradient-to-br from-background to-background p-3 transition-spring hover:scale-105"
                  style={{ minWidth: "76px" }}
                >
